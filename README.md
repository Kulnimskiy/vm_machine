...
работа демонстрируется через несколько подключений клиентов(Виртуальных машин) к серверу.
...
После успешной аутентификации становятся доступны защищённые команды для управления учетом машин на сервере.
